...
WebDriver  driver = new ChromeDriver();
		...
		//driver.findElement(By.xpath("//*[@id='root']//div//div//nav//ul//li[6]//a")).click();
		...
		driver.findElement(By.xpath("//input[@class='custom-file-input']")).sendKeys("C:\\Users\\kul_subbarao\\Desktop\\Testing\\ETS_2019.xls");
